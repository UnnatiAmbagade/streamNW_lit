...
restaurants = pd.DataFrame({
    ...
    'Price_Range': ['20-40', '30-50', '15-25', '10-20', '20-40', '50-70', '15-30', '10-25', '25-45', '30-60'],
...
for i, row in filtered_data.iterrows():
    ...
    st.text_input(f"Review for {row['Name']}:")
    st.slider(f"Rate {row['Name']} (1 to 5):", 1, 5, 3)
...
if not filtered_data.empty:
    ...
    if not filtered_data_clean.empty:
        # Coordinates roughly at the center of India
...
# Address for Copy-Pasting
st.sidebar.title("Address Information")
if not filtered_data.empty:
    st.sidebar.write("Copy and paste these addresses into another app if the map isn't working:")
